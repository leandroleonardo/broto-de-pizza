...
class Estatistica:
    ...
    def __init__(self):
        ...
        self.grupoEstatistica = None
        self.quantidadeUniEstatistica = None
        self.nomeEstatistica = None
        self.dinheiroEstatistica = None
        self.nome = ''
        self.quantidade = ''
        self.data = ''
        self.valor = ''
    ...
    def GerarEstatistica(self):
        ...
        nomeProdutos = sorted(set(nomeProdutos))  # elemento repetido

        # Pega valores de produtos
        ...
        return nomeProdutos, valores


    def GerarEstatisticaOld(self):
        ...
        if self.nomeEstatistica.get() and self.grupoEstatistica.get():
            messagebox.showinfo('Error', 'Escolha arenas um campo')
            return
